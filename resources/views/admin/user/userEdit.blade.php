                    ...
                    <div class="col-md-12">
                        <div class="card mt-2">
                            <div class="card-header">
                                ...
                                <h3 class="card-title">
                                    <a href="{{ route('a_userEdit',['id'=>$user->id]) }}" class="btn btn-warning btn-sm mr-2">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" method="post"
                                    action="{{ route('a_userEdit', ['id' => $user->id]) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="box-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="title" class="col-sm-2 control-label text-lg-right">Password</label>
                                            <div class="col-sm-4">
                                                <input type="password" name="password" value="" maxlength="250"
                                                    size=50 class="form-control">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label for="title" class="col-sm-2 control-label text-lg-right">Confirm Password</label>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                                <select class="form-control select2 select2-hidden-accessible"
                                                    ...
                                                    <option value=1
                                                        @if ($user->status == 1) : {{ 'selected' }} @endif>Yes
                                                    </option>
                                                    <option value=0
                                                        @if ($user->status == 0) : {{ 'selected' }} @endif>No
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
