                ...
                <div class="col-md-12">
                    <div class="card mt-2">
                        <div class="card-header">
                            ...
                            <h3 class="card-title">
                                <a href="{{ route('creditors.index') }}" class="btn btn-warning btn-sm mr-2">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{ route('creditors.update', ['id' => $result->id]) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="date" name="payment_date" class="form-control"
                                            id="payment_date" placeholder="Payment Date" value="{{ $result->payment_date }}" required>
                                    </div>
                                </div>
